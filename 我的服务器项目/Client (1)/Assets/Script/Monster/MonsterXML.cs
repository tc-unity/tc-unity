...
public class MonsterXML : MonoBehaviour {

    public static MonsterXML monxml_Instance;
    ...
    void Awake()
    {
        monxml_Instance = this;
        path = Application.persistentDataPath + "/Monster.xml";
        SetFileToPersistent();
        LoadXml();
    }
...
        FileInfo info = new FileInfo(path);
        ...
        if (!info.Exists)
        {
            TextAsset ts = Resources.Load("Monster") as TextAsset;
